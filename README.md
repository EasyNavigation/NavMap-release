## NavMap (lyrical) - 0.5.1-1

The packages in the `NavMap` repository were released into the `lyrical` distro by running `/usr/bin/bloom-release NavMap --ros-distro lyrical --track lyrical --edit` on `Thu, 30 Jul 2026 18:12:46 -0000`
...
## NavMap (lyrical) - 0.4.0-3

The packages in the `NavMap` repository were released into the `lyrical` distro by running `/usr/bin/bloom-release NavMap --rosdistro lyrical` on `Sun, 26 Jul 2026 07:07:53 -0000`
...
## NavMap (lyrical) - 0.4.0-2

The packages in the `NavMap` repository were released into the `lyrical` distro by running `/usr/bin/bloom-release NavMap --rosdistro lyrical` on `Sun, 26 Jul 2026 07:05:55 -0000`
...
## NavMap (lyrical) - 0.4.0-1

The packages in the `NavMap` repository were released into the `lyrical` distro by running `/usr/bin/bloom-release NavMap --rosdistro lyrical` on `Sat, 25 Jul 2026 08:00:33 -0000`
...
## NavMap (kilted) - 0.4.0-1

The packages in the `NavMap` repository were released into the `kilted` distro by running `/usr/bin/bloom-release --rosdistro kilted --track kilted NavMap --edit` on `Mon, 24 Nov 2025 11:07:38 -0000`
...
## NavMap (jazzy) - 0.3.0-1

The packages in the `NavMap` repository were released into the `jazzy` distro by running `/usr/bin/bloom-release --rosdistro jazzy --track jazzy NavMap` on `Mon, 24 Nov 2025 10:57:04 -0000`
